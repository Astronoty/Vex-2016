...
#pragma config(Motor,  port1,           leftIntake,    tmotorNone, openLoop)
...
#pragma config(Motor,  port4,           leftLift3,     tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port8,           rightLift3,    tmotorVex393_MC29, openLoop, reversed)
